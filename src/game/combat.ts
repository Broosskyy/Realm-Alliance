import{critChance,playerDamage}from"./state";import type{GameState}from"./state";
import{SKILLS,skillMultiplier}from"../data/skills";import type{SkillId}from"../data/skills";
